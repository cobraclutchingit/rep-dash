    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {eventTypes.map((eventType) => (
          <div
            key={eventType.type}
            className={`p-4 rounded-lg border ${getEventTypeColor(eventType.type)} cursor-pointer hover:opacity-90 transition-opacity`}
        ...
        <div className="mt-6 p-4 border rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t text-xs text-muted-foreground">
              Note: This is a UI demonstration. Event type customization 
              functionality is not fully implemented in this version.
            </div>
          </div>
        </div>
      )}
