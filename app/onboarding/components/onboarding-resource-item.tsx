...
export default function OnboardingResourceItem({ resource }: OnboardingResourceItemProps) {
        ...
        return (
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15.536a5 5 0 01.707-7.07l.354-.354"
            />
          </svg>
        );
      default:
  ...
  return (
    <a
      ...
      className="bg-muted/30 hover:bg-muted flex items-center rounded-md p-3 transition-colors"
    >
      <div className="text-muted-foreground mr-3">{getResourceIcon(resource.type)}</div>
      ...
      <div className="ml-3 flex-shrink-0">
        <span className={`rounded-full px-2 py-1 text-xs ${getTypeColor(resource.type)}`}>
