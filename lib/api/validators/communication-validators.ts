...
export const contestSchema = z
  .object({
    ...
    contestType: z.enum(['APPOINTMENTS', 'SALES', 'REFERRALS', 'TEAM_CHALLENGE', 'CUSTOM']),
...
export const communicationFilterSchema = z.object({
  ...
  contestType: z
    .enum(['APPOINTMENTS', 'SALES', 'REFERRALS', 'TEAM_CHALLENGE', 'CUSTOM'])
    .optional(),
  contestStatus: z.enum(['UPCOMING', 'ACTIVE', 'COMPLETED', 'CANCELLED']).optional(),
